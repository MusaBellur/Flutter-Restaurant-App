...
class PopularProductController extends GetxController {
  ...
  void setQuentity(bool isIncrement){
    if (isIncrement) {
      ...
      //print("Quentity tapped: "+_quantity.toString());
    }
    else{
      _quantity=checkQuantity(quantity-1);
      //print("Quentity tapped: "+_quantity.toString());
  ...
  int checkQuantity(int quantity){
    if((_inCartItems+quantity)<0){
      Get.snackbar("Uyarı!", "Daha az sipariş ekleyemezsiniz!",
      ...
      Get.snackbar("Uyarı", "Daha fazla sipariş ekleyemezsiniz!",
      backgroundColor: AppColors.mainColor,
      colorText: Colors.white
      );
      return 20;
  ...
  void initProduct(ProductModel product, CartController cart){
    ...
    //print("Quantity Cart " + _inCartItems.toString());
  }
